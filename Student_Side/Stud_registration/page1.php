            ...
            <div class="form second">
                ...
                <div class="fields" id="seniorFields" style="display: none;">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" type="text" id="SenYear" name="SenYear" required>
                    </div>
                    <div class="input-field2">
                        <label>Awards Received</label>
                        <input type="text" type="text" id="SenAward" name="SenAward">
                    </div>
                </div>
                ...
                <div class="fields" id="elementaryFields" style="display: none;">
                    ...
                    <div class="input-field">
                        <label>Name of the School</label>
                        <input type="text" id="ElemSchool" name="ElemSchool" required>
                    </div>
                    <div class="input-field">
                        <label>Year Graduated</label>
                        <input type="text" id="ElemYear" name="ElemYear" required>
                    </div>
                    <div class="input-field2">
                        <label>Awards Received</label>
                        <input type="text" id="ElemAward" name="ElemAward">
                    </div>
                </div>
                <div class="fields" id="otherFields" style="display: none;">
                    ...
                    <div class="input-field">
                        <label>Name of the School</label>
                        <input type="text" id="OthSchool" name="OthSchool">
                    </div>
                    <div class="input-field">
                        <label>Year Graduated</label>
                        <input type="text" id="OthAward" name="OthAward">
                    </div>
                    <div class="input-field2">
                        <label>Awards Received</label>
                        <input type="text" id="OthAward" name="OthAward">
