...
<body>
  ...
  <div
    style="background-image: url('assets/img/bg.png'); background-repeat: no-repeat; background-size: cover; padding-bottom: 50px;">
    <br>
    <img src="assets/img/GCU.png" alt="" height="200px" width="200px"
      style="display: inline-block; vertical-align: middle; margin-left: 300px;">
