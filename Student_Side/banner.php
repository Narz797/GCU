...
<section class="banner">
  ...
  <div style="background-image: url('bsu.png'); background-repeat: no-repeat; background-size: cover; display:flex; justify-content:center; padding-top:5%; padding-bottom:2%;">
    <br>
