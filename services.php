...
<body>
  ...
  <section id="services" class="services sections-bg"  style=" background: -webkit-linear-gradient(left, #eee6e6, #008374);">
      ...
      <br>
        ...
        <!-- <h2 style="font-family:fantasy;  margin-left:5%;">SERVICES WE OFFER </h2> -->
          <div class="text-box" style="text-align:justify;">
        <b><i>The TuTuKK program of the Guidance and Counseling Unit is an acronym for "Tumulong ken Tumarabay Kanyam Kabsat". This is a maxim that 
        guides us in the conduct of our programs and activities, we aim to provide a comprehensive support system to the students in their entire
        stay in the university. The programs under this care:
        </i></b>
    </div>
        </div>
      ...
      <b>INFORMATION SERVICES </b></h2>
          ...
          <div class="col-lg-6">
            ...
            to talk about stories and insight about life.In the same manner, TUTUKK Dap-ay scheme is to assist the student with his/her
             concern, collaboration with parents is done through parent conference. The Counselor, student, parent/s come together in the 
             ...
             to equip students with skills which will help them to survive the rigors of their college life. The specific topic under this
              includes but not limited to: <br><br>
              ✓ Effective Study Habits <br>
            ...
            <!-- End Stats Item -->
             ...
             <p style="text-align: justify; color: black;"><strong>TUTUKK:"Boom!Papanam?"</strong>This program aimed at helping students plan
              their career path through career exploration and career guidance. The specific under this program not limited to 
              
              <br><br>
              ✓ Self Awareness through Personality. Interest. Ability and Tests <br>
              ✓ Labor Market Information (DOLE)  <br>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            to be equipped with skills they will need to help them be ready in their journey in becoming a worker. It endeavors
             to assist them in surviving their prospective workplace. The specific under this program includes but not limited to: <br><br>
             
            ✔ Workshop on Resume Writing  <br>
            ✔ Test Taking Strategies  <br>
            ✔ Acing Job Interview   <br>
            ✔ Ethics in Workplace  <br>
            ✔ Social Graces  <br>
    ...
    <section id="stats-counter" class="stats-counter">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center">
          ...
          life-skills that will help them cope with difficult life situations. The specific topics under this program Includes but not limited to:
            <br><br>
          ...
          ✓ Suess Management<br>
          ✓ Conflict Resolution Interpersonal Skills<br>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center">
         ...
         and special populations. The specific topics under this program includes:
            <br><br>
          ✓ Bullying Prevention and fibervention 
          ✓ Dealing with Abuse (sexual drugs, etc.) <br>
          ✓ Teenage Pregnancy and Early Parenthood<br>
          ✓ Understanding LGBTs<br>
          ✓ Understanding Children in Conflict with the Law Case Management<br>
          ✓ Love, Courtship and Marriage 
          ✓ Suicide Prevention and Intervention<br>
          ✓ Other mental topics<br>
          ...
          <div class="col-lg-6">
            ...
            <div class="stats-item d-flex align-items-center">
             ...
             <p style="text-align: justify; color: black;"><strong>TUTUKK:"Lasat"</strong>"This is specially designed for Students with Special needs such as the Person with Disabilities, Student Mothers and the like. It aims to provide support to these group of learners by providing several opportunities for them
              to discuss their concerns through a Guidance Support group and facilitation of other TuTukk Programs to the groups. It also includes: <br><br>
              ✓ Financial Literacy
              ✓ Entrepreneurship <br>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            administration of psychological tests (this is coordination with the Testing & Materials Development Unit or TMDU).
        with difficult circumstances. 
