...
if (isset($_POST['aid']) && isset($_POST['tid']) &&  isset($_POST['date']) && isset($_POST['time'])) {
    ...
    try {
        ...
        $sql1 = "UPDATE `appointment` SET `date` = :date, `start_time` = :time, `latest_update` = :datenow WHERE `appointment_id` = :aid";
        ...
        $sql2 = "UPDATE `transact` SET `date_edited` = :datenow WHERE `transact_id` = :tid";
