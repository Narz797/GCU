...
<!-- Get student's data input in h3-->
        ...
        <div class="card-group d-grid">
            <div class="card border one">
                <div>
                    <h2 class="title"> Reason/s for withdrawing enrollment:</h2>
                </div>
                <div class="main-box">
                <div class="box">
...
<!-- Get student fill-up form data -->
                ...
                <div class="action">
                 ...
                 <a href="#divTwo"><button class="no" onclick="status_update('reconsider')">Reconsider&nbsp<i class="ri-timer-2-line"></i></button></a>
                 </div>
            </div>
        </div>
    </div>
...
<!-- This is the pop-up for the three buttons -->
                ...
                <!-- <div class="overlay" id="divOne">
                    <div class="wrapper">
                        <h1>The student's form for withdrawing enrollment is <u class="One">ACCEPTED</u> .</h1>
...
<!-- 
                 ...
                 <div class="overlay" id="divTwo">
                    <div class="wrapper">
                        <h1>The student's form for withdrawing enrollment is being <u class="Two">Reconsidered</u> .</h1>
                        <a href="#" class="close">&times;</a>
                        <div class="popup">
                            <div class="popup2">
                                <form>
...
<!-- Add a function here where the data will be stored -->
                 ...
                 <div class="overlay" id="divThree">
                    <div class="wrapper">
                        <h1>The student's form for withdrawing enrollment is <u class="Three">LACKING</u> .</h1>
                        <a href="#" class="close">&times;</a>
                        <div class="popup">
                            <div class="popup2">
                                <form>
