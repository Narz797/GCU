...
logAudit($id, 'access_readmission page', $id .' has accessed the readmission page');
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
function clearSearchResults2() {
    ...
    function view_form(tid, sid){
                ...
                url: '../../backend/session_forms/set_session_read.php',  // PHP script that sets the session variable
...
function exportToExcel() {
    ...
    XLSX.writeFile(workbook, "Lists of Students for readmission.xlsx");
}
