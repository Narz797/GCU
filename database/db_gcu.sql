...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2023 at 02:05 PM
...
INSERT INTO `referral` (`referral_id`, `transact_id`, `teacher_id`, `reason`, `referred`, `status`) VALUES
(53, 199, 20010101, 'Academic Deficiency/ies', 'fname lname', ''),
(54, 200, 20010101, 'Absent', 'fname lname', ''),
(55, 201, 20010101, 'Academic Deficiency/ies', 'fname lname', '');
...
(199, 111, NULL, 'referral', '2023-11-08 13:54:36', NULL, NULL, 'pending', NULL),
(200, 432, NULL, 'referral', '2023-11-08 13:54:47', NULL, NULL, 'pending', NULL),
(201, 4343, NULL, 'referral', '2023-11-08 13:57:39', NULL, NULL, 'pending', NULL);
...
INSERT INTO `tstable` (`id`, `student_id`, `teacher_id`, `first_name`, `last_name`, `course`, `college`, `year_level`, `gender`, `contact_number`, `GP_name`, `GP_number`, `reason`, `date`, `refer`, `status`) VALUES
(20, '4343', 20010101, '1st', 'last', 'BSIT', '', 'yrlvl', '', 0, 'rtyu', 564646, 'Academic Deficiency/ies', '2023-11-08 13:57:39', 'fname lname', 'pending');
...
--
ALTER TABLE `readmission`
  MODIFY `readmission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `referral`
--
ALTER TABLE `referral`
  MODIFY `referral_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `transact`
  MODIFY `transact_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;
