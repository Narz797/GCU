<div style="background-image: url('assets/img/bg.png'); background-repeat: no-repeat; background-size: cover; display:flex; justify-content:center; padding-top:2%; padding-bottom:2%;">
  <br>
  <img src="assets/img/bsu.png" class="bsu" alt="" style="display: inline-block; vertical-align: middle;  margin-right:3%; width:10%; height:auto;">
  ...
  <div id="RBG" style="display: inline-block; vertical-align: middle; margin-top:2%;">
    ...
    <!-- <h1 style="font-family: fantasy; color:black;"><span>BENGUET STATE UNIVERSITY</span></h1> -->
    ...
    <!-- <h1 style="font-family: fantasy; font-weight: bold; color:black;">GUIDANCE AND COUNSELING UNIT</h1> -->
