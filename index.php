    ...
    <div class="container position-relative" >
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h2 style="font-family: 'Lucida Calligraphy'; color:black;">Welcome to <br> <span style="font-family:fantasy;">BENGUET STATE UNIVERSITY</span></h2>
          <h2  style="font-family: 'Lucida Calligraphy'; color:#f7b801;">Guidance and Counselling Unit</h2>
        </div>
